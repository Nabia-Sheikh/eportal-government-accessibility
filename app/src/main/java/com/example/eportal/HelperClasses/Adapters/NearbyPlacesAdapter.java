package com.example.eportal.HelperClasses.Adapters;
...
import com.example.eportal.HelperClasses.APIData.GetNearbyPlace;
...
public class NearbyPlacesAdapter extends RecyclerView.Adapter<NearbyPlacesAdapter.ViewHolder> {
    ...
    public NearbyPlacesAdapter(MapsFragment placesAdapterClickListener, GoogleMap googleMap) {
